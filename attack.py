...
def main(cfg):
    ...
    print('=>Creating dir')
    saved_dir = os.path.join('Results', cfg.arch + '_npoint' + str(cfg.npoint) + '_' + str(cfg.cc_linf) + '_' + str(cfg.iter_max_steps) + '_' + str(cfg.CFG) + cfg.cls_loss_type + '_' + cfg.dis_loss_type + '_' + str(cfg.initial_const))
...
if __name__ == '__main__':
    ...
    #------------Dataset-----------------------
    parser.add_argument('--data_dir_file', default='data.mat', type=str, help='')
